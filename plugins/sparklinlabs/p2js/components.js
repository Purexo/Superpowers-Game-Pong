...
var P2Body = (function (_super) {
    ...
    P2Body.prototype.setup = function (config) {
        ...
        switch (this.shape) {
            case "rectangle": {
                ...
                this.body.addShape(new window.p2.Rectangle(this.width, this.height));
                break;
            }
            case "circle": {
                this.radius = (config.radius != null) ? config.radius : 1;
                this.body.addShape(new window.p2.Circle(this.radius));
                break;
            }
        }
    ...
    P2Body.prototype._destroy = function () {
        SupEngine.P2.World.remove(this.body);
        this.body = null;
...
var P2BodyMarker = (function (_super) {
    ...
    P2BodyMarker.prototype.setRectangle = function (width, height) {
        if (this.mesh != null)
            this._clearRenderer();
